...
class Fonts extends Options {
	...
	public function font_weights() {
		return array(
			'400' => esc_html_x( '400', 'Button Font Weight', 'pressbook' ),
			'500' => esc_html_x( '500', 'Button Font Weight', 'pressbook' ),
			'600' => esc_html_x( '600', 'Button font Weight', 'pressbook' ),
			'700' => esc_html_x( '700', 'Button font Weight', 'pressbook' ),
		);
	}
}
