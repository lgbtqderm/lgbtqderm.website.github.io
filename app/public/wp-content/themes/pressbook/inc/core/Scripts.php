...
class Scripts implements Serviceable {
	...
	public function enqueue_scripts() {
		// Enqueue fonts.
		wp_enqueue_style( 'pressbook-fonts', self::fonts_url(), array(), null ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
	...
	public function resource_hints( $urls, $relation_type ) {
		if ( wp_style_is( 'pressbook-fonts', 'queue' ) && 'preconnect' === $relation_type ) {
			$urls[] = array(
