...
class Enhance implements Serviceable {
	...
	public function body_classes( $classes ) {
		...
		$classes[] = Content::get_content_layout_body_class();
		$classes[] = Sidebar::get_side_widget_body_class();
	...
	public function excerpt_more( $more ) {
		...
		$more = ( '...<p class="more-link-wrap"><a href="' . esc_url( get_permalink() ) . '" class="more-link">' . sprintf(
			wp_kses(
				...
				__( 'Read More<span class="screen-reader-text"> &ldquo;%s&rdquo;</span> &raquo;', 'pressbook' ),
				array(
					'span' => array(
						'class' => array(),
					),
